...
<!--===============================================================================================-->
	...
	<script>
		...
		$.ajax({
			...
			url: `http://localhost/HousingWeb-Updated/find2.php`,
			...
			success: function(result) {
				...
				$( ".well" + i).append('<img class="pIMG" src="' + result[i]['ImageLink'] +'" alt="No image was found"><p>' + result[i]['PropertyName'] + '</p><div class="btn-group"><button onclick=' + "'location.href = '';'" + 'id="Manage">Manage</button><button onclick=' + "'location.href = '';'" + 'id="Analytics">Analytics</button><button onclick=' + "'location.href = '';'" + 'id="Settings">Settings</button></div>');
				console.log(result);
